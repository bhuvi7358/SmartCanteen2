...
public class ChefRegistration extends AppCompatActivity {
    String[] Tamil_Nadu = {"Ariyalur","Chengalpattu","Chennai","Coimbatore","Cuddalore","Dharmapuri","Dindigul","Erode","Kallakurichi","Kanchipuram","Karur","Krishnagiri",
            "Madurai","Mayiladuthurai","Nagapattinam","Namakkal","Nilgiris","Perambalur","Pudukottai","Ramanathapuram","Ranipet","Salem","Sivagangai","Tenkasi",
            "Thanjavur","Theni","Thoothukudi","Tiruchirappalli","Tirunelveli","Tirupathur","Tiruppur","Tiruvannamalai","Tiruvarur","Vellore","Villupuram","Virudhunagar"};
    String[] Kerala = {"Thiruvananthapuram", "Kollam", "Pathanamthitta", "Alappuzha","Kottayam", "Idukki", "Ernakulam", "Thrissur", "Palakkad",
            "Malappuram", "Kozhikode", "Wayanad", "Kannur", "Kasaragod"};
    String[] AndhraPradesh = {
            "Visakhapatnam", "Vijayawada", "Guntur", "Nellore",
            "Kurnool", "Kadapa", "Rajahmundry", "Kakinada",
            "Tirupati", "Anantapur", "Ongole", "Chittoor",
            "Eluru", "Srikakulam", "Vizianagaram", "Machilipatnam"
    };
    String[] Telangana = {
            "Hyderabad", "Warangal", "Nizamabad", "Karimnagar",
            "Khammam", "Mahbubnagar", "Ramagundam", "Adilabad",
            "Siddipet", "Nalgonda", "Miryalaguda", "Mancherial",
            "Bhadrachalam", "Vikarabad", "Suryapet", "Zaheerabad"
    };
    String[] Karnataka = {
            "Bengaluru", "Mysuru", "Hubballi-Dharwad", "Mangaluru",
            "Belagavi", "Kalaburagi", "Ballari", "Shivamogga",
            "Davangere", "Udupi", "Tumakuru", "Vijayapura",
            "Bidar", "Chikkamagaluru", "Raichur", "Hassan",
            "Kolar", "Gadag", "Chitradurga", "Ramanagara"
    };
    String[] MadhyaPradesh = {
            "Bhopal", "Indore", "Gwalior", "Jabalpur",
            "Ujjain", "Sagar", "Ratlam", "Rewa",
            "Satna", "Dewas", "Murwara (Katni)", "Chhindwara",
            "Shivpuri", "Vidisha", "Damoh", "Mandsaur",
            "Neemuch", "Khandwa", "Hoshangabad", "Sehore"
    };
    String[] Maharashtra = {
            "Mumbai", "Pune", "Nagpur", "Nashik",
            "Thane", "Aurangabad", "Solapur", "Kolhapur",
            "Navi Mumbai", "Sangli", "Jalna", "Chandrapur",
            "Akola", "Amravati", "Ratnagiri", "Satara",
            "Latur", "Yavatmal", "Parbhani", "Bhusawal"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Tamil Nadu")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : Tamil_Nadu){
                        list.add(cities);
                    }
                ...
                if(statee.equals("kerala")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : Kerala){
                        list.add(cities);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegistration.this,android.R.layout.simple_spinner_item,list);
                    Cityspin.setAdapter(arrayAdapter);
                }
                if(statee.equals("Andhra Pradesh")){
                    ArrayList<String> list = new ArrayList<>();
                ...
                if(statee.equals("Madhya Pradesh")) {
                    ArrayList<String> list = new ArrayList<>();
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    ...
                                                                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(ChefRegistration.this,OtpSend.class);
